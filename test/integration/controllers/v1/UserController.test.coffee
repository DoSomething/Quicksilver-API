...
describe 'Requests to the root (/user/password) path with missing required body parameters.', ->
  it 'POST: Invalid password reset request with missing body parameters returns expected 422 - Unprocessable due to request validation error results.', (done) ->
...
describe 'Requests to the root (/user/password) path', ->
